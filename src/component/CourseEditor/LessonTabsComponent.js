...
import {createLesson_dis, findLessonForModule_dis, deleteLesson_dis,updateLesson_dis} from "../../actions/LessonAction";
            ...
            <div className=" wbdv-lesson-tab">
                <ul className="nav nav-tabs nav-justified">
                    {this.props.lessons && this.props.lessons.map(lesson =>
                        <Link to={`/course-editor/${this.props.courseTitle}/${this.props.courseId}/module/${this.props.moduleId}/lesson/${lesson._id}`}>

                            <LessonItemComponent
                                key = {lesson._id}
                                lesson = {lesson}

                                edit = {() => {this.props.history.push(`/course-editor/${this.props.courseTitle}/${this.props.courseId}/module/${this.props.moduleId}`)
                                    this.setState({
